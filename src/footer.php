...
<div class="col-lg-offset-5 col-xs-offset-1 col-md-offset-3 col-md-offset-3 col-lg-2 col-xs-10 col-sm-10 col-md-4">
    ...
    <p><a class="social-links" href="https://www.twitter.com/RepeaterDigital" title="Twitter Link"><img height="24" width="24"  src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/v-1.svg" alt="Twitter logo" /></a><a href="https://www.instagram.com/RepeaterDigital" title="Instagram Link"><img height="24" width="24"  src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/v-2.svg" alt="Instagram logo"/></a> @RepeaterDigital</p>
                </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-NJN6Y66DWL"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-NJN6Y66DWL');
</script>
