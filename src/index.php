...
<div class="content">
    <h1 class="animate__fadeInDown">We change narratives</h1>
</div>
...
<div>
<img class="animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_2.jpg" alt="Card Deck Design" width="900"  />      
</div>       
<div>
<img class="animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_3.jpg" alt="Posrter of native woman, Illustration by Dylan Petrohilos" width="1200"/>   
</div>
<div>
<img class="animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_4.jpg" alt="Look Book For DC Action Lab, Photo of Noor Mir"  width="1200"/>   
</div>
<div>
<img class="multiply animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_7.jpg" alt="Graphic Poster"  width="800"/>   
</div>
<div>
<img class="multiply animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_8.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
<div id="vision" class="content sub-item"><div>
    <h2 class="animate__fadeInDownBig">Vision</h2>
    <p class="animate__fadeIn">We are a worker owned, self-managed communications consulting firm that specializes in strategic digital and visual communication. </p>
    <p class="animate__fadeIn">Repeater Digital strives to isolate the signal from the noise. We use the power of storytelling to transmit and amplify the voices of our partners across the shared global digital community. </p></div><div>
    <h2 class="animate__fadeInDownBig">Mission</h2>
    <p class="animate__fadeIn">We are movement architects who create visual and organizational designs that challenge narratives and shape public opinion.</p>
...
<div>
<img class="multiply animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_9.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
...
<div>
<img class="multiply animate__fadeIn" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_12.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
<div class="content animate__fadeIn">
    <h3>We offer</h3>
    <p>Brand identity,<br>
...
<div id="past" class="content client_content animate__fadeIn"><h3>Our past clients</h3>
    ...
    <div class="logo_wrapper animate__fadeIn">
...
<div id="projects" class="content clients_wrapper grid-item-7 grid-item animate__fadeOutUp">
