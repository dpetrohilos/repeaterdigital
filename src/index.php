...
<div>
<img class="multiply animate__fadeInDown animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_1.jpg" alt="" width="1200"/>   
</div>
<div>
...
<div>
<img class="animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_2.jpg" alt="Card Deck Design" width="900"  />      
</div>       
<div>
<img class="animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_3.jpg" alt="Posrter of native woman, Illustration by Dylan Petrohilos" width="1200"/>   
</div>
<div>
<img class="animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Img_4.jpg" alt="Look Book For DC Action Lab, Photo of Noor Mir"  width="1200"/>   
</div>
<div>
<img class="multiply animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_7.jpg" alt="Graphic Poster"  width="800"/>   
</div>
<div>
<img class="multiply animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_8.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
...
<div>
<img class="multiply animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_9.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
...
<div>
<img class="multiply animate__fadeIn animate__animated" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Front_Image_12.jpg" alt="Graphic Poster"  width="1200"/>   
</div>
<div class="content animate__fadeIn animate__animated">
    <h3>We offer</h3>
    <p>Brand identity,<br>
